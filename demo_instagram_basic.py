...
print(
    f"    {DIM}fields=id,username,name,profile_picture_url,followers_count,follows_count,media_count{RESET}"
)
print()
pause()
...
print(
    f"    {DIM}fields=id,caption,media_type,media_url,thumbnail_url,timestamp,like_count,comments_count{RESET}"
)
print()
pause()
