"""
Screencast demo for a new Meta application review — pages_show_list permission.
...
# -------------------------------------------------------------------------
header("Polaris Innovations -- New App pages_show_list Demo")
...
calls = [
    ...
    (
        ...
        "create post    (instagram_content_publish)",
    ),
    (
        "GET",
        f"/v18.0/{ig_user_id}/insights",
        "analytics      (instagram_manage_insights)",
    ),
    (
        "GET",
        f"/v18.0/<media_id>/comments",
        "comments       (instagram_manage_comments)",
    ),
    (
        "POST",
        f"/v18.0/<comment_id>/private_replies",
        "send DM        (instagram_manage_messages)",
    ),
